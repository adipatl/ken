...
namespace WPFClient
{
    ...
    public partial class MainWindow : Window
    {
        ...
        //const string ServerURI = "http://localhost:3979/signalr";
        const string ServerURI = "http://kenbottr.azurewebsites.net/signalr";
        ...
        private async void ConnectAsync()
        {
            ...
            HubProxy = Connection.CreateHubProxy("EikonCiInteraction");
